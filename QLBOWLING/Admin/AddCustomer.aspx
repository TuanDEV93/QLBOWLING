<%@ Page Title="Thêm khách hàng" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddCustomer.aspx.cs" Inherits="QLBOWLING.Admin.AddCustomer" %>
                    ...
                    <div class="col-lg-6">
                        <div class="p-4">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtEmail1" runat="server" CssClass="form-control" Placeholder="pvduc123@gmail.com ..."></asp:TextBox>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtAddress1" runat="server" CssClass="form-control" Placeholder="Hà Nội ..."></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
